    ...
    return (
        <>
            <div className="preFooter">
                <div>{<BsArrowRepeat />} <p> <b>Hassle-free replacement</b> <br /> 10-day easy replacement policy on mi.com </p></div>

                <div>{<BiCheckShield />} <p> <b>100% secure payments</b> <br /> We support Cards, wallets, EMI and COD </p></div>


                <div>{<BsMap />} <p> <b>Vast service network</b> <br /> 1000 Mi service-centers across 600 cities</p></div>
            ...
            <div className="preFooter2">
                ...
                <div>
                    <div><input type="email" name='email' placeholder='Enter Email Address' />
