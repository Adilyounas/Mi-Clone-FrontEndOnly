...
const HotAccessories = ({ music, musicCover, smartDevice, smartDeviceCover, home, homeCover, lifeStyle, lifeStyleCover, mobileAccessories, mobileAccessoriesCover }) => {
    return (
        <div className="HotAccessories">
            ...
            <div>
                {
                    music && music.map((items, index) => {
                        return <HotItemCard
                            key={items.image} name={items.name} price={items.price} image={items.image} index={index} />
                    })
                }
                ...
                {
                    smartDevice && smartDevice.map((items, index) => {
                        return <HotItemCard
                            key={items.image} name={items.name} price={items.price} image={items.image} index={index} />
                    })
                }
                ...
                {
                    lifeStyle && lifeStyle.map((items, index) => {
                        return <HotItemCard
                            key={items.image} name={items.name} price={items.price} image={items.image} index={index} />
                    })
                }
                ...
                {
                    mobileAccessories && mobileAccessories.map((items, index) => {
                        return <HotItemCard
                            key={items.image} name={items.name} price={items.price} image={items.image} index={index} />
                    })
                }
